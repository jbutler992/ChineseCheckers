    ...
    if(count == 0){//root
        for(var i = 0; i < possibleMoves.length; i++){
            if(posNextMoves[i]%2 != 0)
                continue;
            else if(findEmpty(board).length > 22){
                flag=true;
                console.log("Flag set TRUE!");
			}
			else if(posNextMoves[i] == 0){
                console.log("WIN SCENARIO = 0!!! moveToTake index = "+i+" posNextMoves value = "+posNextMoves[i]);
                return i;
            }
            else if(posNextMoves[i] == 2){
                console.log("WIN SCENARIO = 2!!! moveToTake index = "+i+" posNextMoves value = "+posNextMoves[i]);
                return i;
            }
            else{
                if(flag==false){
                    ...
                    console.log("Highest Even equals: "+highestEven);
                    if(posNextMoves[i] < highestEven){
                        highestEven = posNextMoves[i];
                        console.log("Highest Even Set to: "+highestEven);
                        moveToTake = i;
        ...
        console.log("Move to take equals: "+moveToTake+" posNextMoves value = "+posNextMoves[moveToTake]);
        return moveToTake;
    }
...
function makeMoves(){
	...
	var moveToTake = evaluation(initialBoard, 11, -9998, 9999, count);
